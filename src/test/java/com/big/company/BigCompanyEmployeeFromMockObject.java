...
public class BigCompanyEmployeeFromMockObject implements BigCompanyEmployeeProvider{
    ...
    public int loadEmployeeData() {
        try {
            ...
            employee0.addSubordinate(employee1);
            ...
            BigCompanyEmployee employee3 = new BigCompanyEmployee(3, "Williams", "James", 650000.00, employee1);
            ...
            employee2.addSubordinate(employee6);
            ...
            employee2.addSubordinate(employee7);
            ...
            employee3.addSubordinate(employee8);
            ...
            employee3.addSubordinate(employee9);
            ...
            employee3.addSubordinate(employee10);
            ...
            employee4.addSubordinate(employee11);
            ...
            employee4.addSubordinate(employee12);
            ...
            employee4.addSubordinate(employee13);
            bigCompanyEmployeeMap.put(13, employee13);

            //5
            BigCompanyEmployee employee14 = new BigCompanyEmployee(14, "Wilson", "Paul", 360000.00, employee11);
            employee11.addSubordinate(employee14);
            bigCompanyEmployeeMap.put(14, employee14);

            BigCompanyEmployee employee15 = new BigCompanyEmployee(15, "Anderson", "Mark", 350000.00, employee11);
            employee11.addSubordinate(employee15);
            bigCompanyEmployeeMap.put(15, employee15);

            BigCompanyEmployee employee16 = new BigCompanyEmployee(16, "Thomas", "Donald", 340000.00, employee11);
            employee11.addSubordinate(employee16);
            bigCompanyEmployeeMap.put(16, employee16);

            BigCompanyEmployee employee17 = new BigCompanyEmployee(17, "Taylor", "Steven", 330000.00, employee14);
            employee14.addSubordinate(employee17);
            bigCompanyEmployeeMap.put(17, employee17);

            BigCompanyEmployee employee18 = new BigCompanyEmployee(18, "Moore", "George", 320000.00, employee14);
            employee14.addSubordinate(employee18);
            bigCompanyEmployeeMap.put(18, employee18);

            BigCompanyEmployee employee19 = new BigCompanyEmployee(19, "Jackson", "Kenneth", 310000.00, employee18);
            employee14.addSubordinate(employee19);
            bigCompanyEmployeeMap.put(19, employee19);

            BigCompanyEmployee employee20 = new BigCompanyEmployee(20, "Martin", "Joshua", 300000.00, employee19);
            employee19.addSubordinate(employee20);
